 ...
 * If a sport is missing, fill with remaining matches sorted by confidence.
 */
function getTop3(matches: CachedMatch[]): CachedMatch[] {
  ...
  // Sort pool by highest confidence probability
  ...
  // 1st pass: one per sport (best confidence within each sport)
  ...
  // 2nd pass: fill to 3 with best remaining (no duplicate fixture_id)
