...
export const Elite5Preview = memo(function Elite5Preview({ matches }: Elite5PreviewProps) {
  ...
  return (
    <div className="container px-3 sm:px-4 mt-6">
      <motion.div
      ...
      >
        ...
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {elite5.map((match, i) => (
            ...
            >
              ...
              <div className="rounded-2xl border border-[rgba(255,215,0,0.12)] bg-[rgba(255,215,0,0.02)] relative overflow-hidden">
                {canSeeDetails ? (
                  <MatchCard match={match} index={i} />
                ) : (
                  <>
                    <MatchCard match={match} locked index={i} />
                    <div className="absolute inset-x-0 bottom-0 h-1/2 bg-gradient-to-t from-background/95 via-background/70 to-transparent flex flex-col items-center justify-end pb-3">
        ...
        {!canSeeDetails && (
          ...
          >
            <Link to="/pricing">
              <Button size="sm" className="gap-2 text-xs font-semibold btn-shimmer">
        ...
        {canSeeDetails && (
          ...
          >
            <Link to="/matches">
              <Button variant="outline" size="sm" className="gap-2 text-xs border-primary/20 text-primary hover:bg-primary/10">
