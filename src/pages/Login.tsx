              ...
              {isRegister && (
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <Input id="name" placeholder="John Doe" className="bg-muted/50 pl-9 h-9 text-sm" />
                  </div>
                </div>
              )}
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <Input id="email" type="email" placeholder="vous@email.com" className="bg-muted/50 pl-9 h-9 text-sm" />
                </div>
              </div>
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <Input id="password" type="password" placeholder="••••••••" className="bg-muted/50 pl-9 h-9 text-sm" />
                </div>
              </div>
              <Button className="w-full gap-2 h-9 text-sm" type="submit">
